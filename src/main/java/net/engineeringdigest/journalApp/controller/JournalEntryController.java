...
public class JournalEntryController {
    ...
    public  ResponseEntity<?>  getJournalEntry(@PathVariable String id,@PathVariable String username){
    ...
    public ResponseEntity<?>  postJournalEntry(
        ...
        journalEntryService.saveEntry(journalEntryEntity,username);
    ...
    public ResponseEntity<?> editJournalEntry(
        ...
        if(!journalEntryService.editEntry(journalEntryEntity,username)) {
